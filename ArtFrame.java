...
public class ArtFrame extends JFrame implements ActionListener {
  ...
  private JLabel timeForGenerate;                   // This label will show time that use for generate the random art panel
  private JButton buttonGenerate;                   // The generate button will repaint the random art panel
  
  private static final int EQUATION_FONT_SIZE = 16; // The defualt size of front
  private ArrayList<JMenuItem> itemHeight;          // Represent the all of menu height, for input of user
